        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {trendsData.map((product) => (
            <div key={product.id} className="shadow-md rounded-md overflow-hidden">
              <img src={product.image} alt={product.title} className="w-full h-40 rounded-xl object-cover"/>
              <div className="px-4 py-2">
                <p className="text-lg font-semibold mb-2">{product.title}</p>
                <p className="text-gray-600 text-sm h-16 overflow-hidden">{product.description}</p>
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <p className="text-sm text-gray-500">{`${product.rating} (${product.reviews} Reviews)`}</p>
                  </div>
                </div>
                ...
                <button className="bg-blue-500 text-white rounded-md px-2 py-1 mt-4 w-1/2">
                  Shop Now
                </button>
              </div>
            </div>
